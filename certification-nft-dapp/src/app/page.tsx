...
export default function Home() {
  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <div className="mb-6">
              ...
              >
                Learn the fundamentals of blockchain, TON, and NFTs. Complete
                short modules to earn a verified certification NFT on TON
                testnet.
              </p>
            </div>
            <button
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                <div
                  className={`absolute inset-0 rounded-xl blur-lg opacity-30 transition-colors duration-300 ${
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        ...
        <section className="mt-8 mb-8">
          <div className="text-center mb-8">
            ...
            >
              Short, practical modules to help you understand blockchain
              fundamentals, TON's architecture, and NFT mechanics — then mint a
              verifiable certificate to your wallet.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div
              className="bg-gray-800 p-6 rounded-xl shadow-lg border transition-all duration-300 hover:scale-105 ${
            ...
            >
              ...
              <p className="text-sm text-gray-400 mb-6 leading-relaxed">
                Learn how distributed ledgers work, why they’re secure, and how
                transactions are validated — the core concepts you need to build
                on Web3.
              </p>
              <div className="flex items-center justify-between mb-4">
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div
                  className={`p-3 rounded-lg w-fit transition-all ${
                    courseProgress.ton ? "bg-green-900/50" : "bg-pink-900/50"
                  }`}
                >
                  <svg
                    className={`w-6 h-6 transition-colors ${
              ...
              <p className="text-sm text-gray-400 mb-6 leading-relaxed">
                Understand TON's design goals, performance characteristics, and
                how it enables fast, low-cost transactions for decentralized
                apps.
              </p>
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-1 text-xs text-gray-500">
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div
                  className={`p-3 rounded-lg w-fit transition-all ${
                    courseProgress.nfts ? "bg-green-900/50" : "bg-green-900/50"
                  }`}
                >
                  <svg
                    className={`w-6 h-6 transition-colors ${
              ...
              <p className="text-sm text-gray-400 mb-6 leading-relaxed">
                Learn how NFTs represent ownership, how metadata and provenance
                work, and how to mint and verify tokens on TON.
              </p>
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-1 text-xs text-gray-500">
                  <BookOpen className="w-3 h-3" />
        ...
        <section className="mb-8">
          <div
            className={`backdrop-blur-sm rounded-3xl p-8 border-2 shadow-2xl transition-colors duration-300 ${
              isDarkMode
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p
                  className={`text-base mt-2 transition-colors duration-300 ${
                    isDarkMode ? "text-gray-300" : "text-gray-600"
                  }`}
                >
            ...
            <div
              className={`w-full rounded-full h-4 mb-6 shadow-inner transition-colors duration-300 ${
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-purple-200 text-xs mb-3">
                  You completed all modules — your certified NFTs are available
                  in the Alpha Vault.
                </p>
        ...
        <section id="certificate-explorer" className="mb-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-4">
            <div>
              <h2
                className={`text-xl sm:text-2xl font-bold transition-colors duration-300 ${isDarkMode ? "text-white" : "text-gray-900"}`}
              >
                Token Viewer
              </h2>
              <p
        ...
        {!userAddress && (
          <section className="p-6 bg-gray-800 rounded-2xl text-center mb-8 shadow-lg border border-gray-700">
            <div className="max-w-xl mx-auto">
              ...
              />
              <h3
                className={`text-lg sm:text-2xl font-bold mb-2 transition-colors duration-300 ${
                  isDarkMode ? "text-white" : "text-white"
                }`}
              >
                Connect your wallet
              ...
              >
                Sign in with TON to mint certificates, verify ownership, and
        ...
        <section className="mt-12">
          <div className="text-center mb-10">
            <h2
              className={`text-3xl sm:text-4xl font-black mb-4 transition-colors duration-300 ${
                isDarkMode ? "text-white" : "text-gray-900"
              }`}
            >
              Why Join Alpha DAO?
            ...
            <p
              className={`text-lg sm:text-xl font-semibold max-w-2xl mx-auto transition-colors duration-300 ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            <div
              className={`p-8 rounded-3xl shadow-2xl border-2 hover:shadow-3xl hover:scale-[1.02] transition-all duration-300 ${
                isDarkMode
            ...
            >
              <div
                className={`p-4 rounded-2xl w-fit mb-6 border transition-colors duration-300 ${
                  isDarkMode
              ...
              >
                Certificates are stored on-chain so anyone can verify
            ...
            >
              ...
              >
                Alpha members help shape curriculum and standards through DAO
                governance.
              </p>
            </div>
            <div
            ...
            >
              ...
              >
                Your certification lives in your wallet — portable, verifiable,
      ...
      <footer
        className={`mt-16 py-12 border-t-2 transition-colors duration-300 ${
          isDarkMode
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-8">
            <div className="md:col-span-2">
              ...
              <p
                className={`text-lg mb-6 leading-relaxed font-medium transition-colors duration-300 ${
                  isDarkMode ? "text-gray-300" : "text-gray-700"
                }`}
              >
                A simple way to learn Web3 concepts and mint verifiable
                certifications on TON testnet.
              </p>
              <div className="flex items-center gap-4 text-base">
                ...
                <code
                  className={`text-sm px-4 py-2 rounded-xl font-mono shadow-lg border-2 transition-colors duration-300 ${
                    isDarkMode
            ...
            <div>
              ...
              <ul
                className={`space-y-3 text-base transition-colors duration-300 ${
                  isDarkMode ? "text-gray-400" : "text-gray-600"
                }`}
              >
                <li>
          ...
          <div
            className={`pt-8 border-t-2 flex flex-col sm:flex-row justify-between items-center gap-6 transition-colors duration-300 ${
          ...
          >
            ...
            <div
              className={`flex items-center gap-3 text-base font-semibold transition-colors duration-300 ${
                isDarkMode ? "text-gray-400" : "text-gray-600"
              }`}
            >
              <span
                className={`w-3 h-3 rounded-full animate-pulse shadow-lg transition-colors duration-300 ${
